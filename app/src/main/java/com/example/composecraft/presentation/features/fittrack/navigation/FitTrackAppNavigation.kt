...
import com.example.composecraft.presentation.features.fittrack.screens.AddExerciseBasicInfo
import com.example.composecraft.presentation.features.fittrack.screens.AddExerciseDetails
import com.example.composecraft.presentation.features.fittrack.screens.BlockEditor
import com.example.composecraft.presentation.features.fittrack.screens.CreateWorkout
import com.example.composecraft.presentation.features.fittrack.screens.ExerciseDetails
import com.example.composecraft.presentation.features.fittrack.screens.ExerciseLibrary
import com.example.composecraft.presentation.features.fittrack.screens.ExerciseSetsEditor
import com.example.composecraft.presentation.features.fittrack.screens.Home
import com.example.composecraft.presentation.features.fittrack.screens.PlanOverview
import com.example.composecraft.presentation.features.fittrack.screens.Profile
import com.example.composecraft.presentation.features.fittrack.screens.SetCompletion
import com.example.composecraft.presentation.features.fittrack.screens.SetTracking
import com.example.composecraft.presentation.features.fittrack.screens.ShareWorkout
        ...
        FitTrackNavigationShell(
            ...
            NavDisplay(
                ...
                entryProvider = entryProvider {
                    ...
                    entry<ExerciseLibraryDestination> {
                        ExerciseLibrary()
                    }
                    entry<AddExerciseBasicInfoDestination> {
                        AddExerciseBasicInfo()
                    }
                    entry<AddExerciseDetailsDestination> {
                        AddExerciseDetails()
                    }
                    entry<ExerciseDetailsDestination> {
                        ExerciseDetails()
                    }
                    entry<PlanOverviewDestination> {
                        PlanOverview()
                    }
                    entry<BlockEditorDestination> {
                        BlockEditor()
                    }
                    entry<ExerciseSetsEditorDestination> {
                        ExerciseSetsEditor()
                    }
                }
            )
